...
//
// Check the links above for version updates.
// 
...
dependencies {
    ...
    compile group: 'com.ibm.mobile.services', name: 'imfdata-local', version: '1.1.0'
    compile group: 'com.ibm.mobile.services', name: 'cloudant-toolkit-local', version: '1.1.0'
...
<ivy-module version="2.0">
    ...
    <dependencies>
        <dependency org="com.ibm.mobile.services" name="imfdata-local" rev="1.1.0" >
            <artifact name="imfdata-local" type="aar"/>
        </dependency>
        <dependency org="com.ibm.mobile.services" name="cloudant-toolkit-local" rev="1.1.0" >
